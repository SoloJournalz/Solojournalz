...
const previewCards = [
  {
    ...
    text: "Log trades, screenshots, notes, and execution context in one clean workspace.",
  },
  {
    title: "Performance review",
    text: "Spot patterns across setups, trading environments, behaviour, and consistency.",
  },
  {
    title: "Built for discipline",
    text: "A calmer SaaS workspace designed for traders who want clarity, not noise.",
  },
];
    ...
    <>
      ...
      <main className="min-h-screen overflow-x-hidden bg-[#f7f7f5] text-black">
        <section className="relative overflow-hidden border-b border-black/10">
          <div className="absolute left-1/2 top-12 h-[440px] w-[440px] max-w-[90vw] -translate-x-1/2 rounded-full bg-[#7f1010]/10 blur-3xl" />

          <div className="relative mx-auto flex min-h-[calc(100vh-96px)] max-w-6xl flex-col items-center justify-center px-4 py-16 text-center sm:px-6 lg:px-10">
            ...
            <h1 className="mt-6 max-w-4xl text-4xl font-black leading-[1.03] tracking-tight sm:text-5xl lg:text-7xl">
              Coming soon for disciplined traders.
            </h1>

            <p className="mt-7 max-w-2xl text-base leading-8 text-[#5f6673] sm:text-lg lg:text-xl">
              SoloJournalz is in private development while we finish production testing, responsive polish, and launch preparation.
            </p>
            ...
            <p className="mt-10 text-sm font-semibold text-[#6b7280]">
              Private access is currently limited to the SoloJournalz development team.
            </p>
          </div>
        </section>
      </main>
